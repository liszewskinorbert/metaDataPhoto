...
def process_image(file_path, output_path, resolution=(576, 768), dpi=(96, 96)):
    # Otwórz obraz
    img = Image.open(file_path)
    ...
    img_resized = img_resized.convert("RGB")  # Konwersja do 24-bitowego obrazu

    # Zapisz przetworzony obraz z metadanymi EXIF
    img_resized.save(output_path, "JPEG", quality=95, dpi=dpi, exif=exif_data)

    print(f"Przetworzony obraz został zapisany jako {output_path}")

# Użycie funkcji
file_path = '20250206_094615.jpg'
output_path = 'processed_' + file_path

# Wyświetl oryginalne metadane
print("Oryginalne metadane:")
print_jpg_metadata(file_path)

# Przetwórz obraz
process_image(file_path, output_path)

# Wyświetl metadane przetworzonego obrazu
print("\nMetadane przetworzonego obrazu:")
print_jpg_metadata(output_path)
